...
//			Assert.assertEquals(actualName, enteredName, "Wrong name!!");
	...
	public void insertInToSearchBar() {
		SEARCH_BAR_LIST_CUSTOMER_ELEMENT.sendKeys(enteredName);
	}
	...
	public void verifySearchBarAndProfile() {
		for(int i = 1; i<=5; i++) {
			...
			System.out.println(enteredNameSearch);
			if(enteredNameSearch.contains(enteredName)) {
				System.out.println("Searh bar contains entered name!!");
